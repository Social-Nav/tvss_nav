...
typedef std::vector<tvsn_msgs::SemanticInstance> SocialObservation;
...
private:
  void callback(const tvsn_msgs::SemanticInstanceArrayConstPtr& msg){
...
protected:
  ...
  tvsn_msgs::SemanticInstanceArray last_received_instances_;
