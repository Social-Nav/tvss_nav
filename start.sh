...
gnome-terminal -- bash -c "source ~/anaconda3/etc/profile.d/conda.sh && conda activate gsam2 && cd ./tvss_nav/scripts/tvss_nav/ && PYTHONPATH=. python vlm/vlm.py; exec bash" & get_new_pts
# -------- Exit handling --------
