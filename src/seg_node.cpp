...
private:
    ...
    void handleRgbInfo(const sensor_msgs::CameraInfoConstPtr& msg) {
        ...
        // ROS_INFO("Camera intrinsics set: %dx%d", rgb_image_size_.width, rgb_image_size_.height);
    }
    ...
    void processData(const sensor_msgs::PointCloud2ConstPtr& cloud_msg,
        ...
        // ROS_INFO("Processing point cloud and label mask data...");
        ...
        // ROS_INFO("Published %zu semantic instances and visual cloud with %zu points.",
        //          semantic_instances.instances.size(), merged_cloud.size());
    }
    ...
    void AddInstance(int label, const pcl::PointCloud<pcl::PointXYZRGB>& cloud,
        ...
        // ROS_INFO("Adding instance: label=%d, class='%s', points=%zu",
                //  label, class_name.c_str(), cloud.size());
        ...
        // ROS_INFO("Instance added: id=%d, class='%s', points=%zu",
        //          instance.instance_id, instance.class_name.c_str(), cloud.size());
    }
};
