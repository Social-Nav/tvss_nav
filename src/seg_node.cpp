...
#include <tvsn_msgs/SemanticInstance.h>
...
public:
        ...
        : nh_(nh), tf_buffer_(), tf_listener_(tf_buffer_)
    {
        ...
        semantic_pub_ = nh_.advertise<tvsn_msgs::SemanticInstanceArray>(instance_array_topic_, 1);
...
private:
    ...
    message_filters::Subscriber<tvsn_msgs::StringStamped> instance_class_sub_;
    ...
    typedef message_filters::sync_policies::ExactTime<sensor_msgs::PointCloud2, sensor_msgs::CompressedImage, tvsn_msgs::StringStamped> ExactSyncPolicy;
    ...
    void processData(const sensor_msgs::PointCloud2ConstPtr& cloud_msg,
                     ...
                     const tvsn_msgs::StringStampedConstPtr& class_msg) {
        ...
        tvsn_msgs::SemanticInstanceArray semantic_instances;
    ...
    void AddInstance(int label, const pcl::PointCloud<pcl::PointXYZRGB>& cloud,
                     ...
                     tvsn_msgs::SemanticInstanceArray& array,
                     int cost_value = 254,
                     float inflation_radius = 1.0,
                     float decay_rate = 2.7685,
                     const std::string& class_name = "unknown") {
        tvsn_msgs::SemanticInstance instance;
